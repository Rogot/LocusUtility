...
#ifndef DRONEDEVICE_FASTCRC32_HPP_
#define DRONEDEVICE_FASTCRC32_HPP_
...
public:
	...
	FastCrc32() = delete;
	FastCrc32(const FastCrc32 &) = delete;
	FastCrc32 &operator=(const FastCrc32 &) = delete;
	...
	static uint32_t update(uint32_t aChecksum, const void *aBuffer, size_t aLength)
	{
		...
		while (aLength--) {
			aChecksum = (aChecksum >> 8) ^ table[(aChecksum ^ *buffer++) & 0xFF];
		}
...
#endif // DRONEDEVICE_FASTCRC32_HPP_
