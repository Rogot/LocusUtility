...
public:
	...
	//!
	//! \brief getFieldType Synchronously returns a type of the field.
	//! Field types should be cached in an object of a derived class.
	//!
	virtual FieldType getFieldType(FieldId aField) = 0;
